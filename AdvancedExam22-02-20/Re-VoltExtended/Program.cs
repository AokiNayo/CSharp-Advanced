...
namespace Re_VoltExtended
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            for (int i = 0; i < cmdCount; i++)
            {
                ...
                else if (matrix[currRow, currCol] == 'B')
                {
                    ...
                    else if (matrix[currRow, currCol] == 'B') // TO DO:
                    {
                        Movement(input, ref currRow, ref currCol);
                        CheckIfOut(n, input, ref currRow, ref currCol);
                    }
                    if (matrix[currRow, currCol] == 'T') // TO DO:
                    {
                        MoveBack(input, ref currRow, ref currCol);
        ...
        private static void MoveBack(string input, ref int currRow, ref int currCol)
        {
            switch (input)
            {
                case "up":
